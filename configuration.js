  ...
  description: {
    ...
    FR: {
      short: `Mathieu Faro Sole est un doctorant en sciences politiques
        conduisant une thèse intitulée "les préfets et la gestion de l'eau", intégrée au projet BlueState. <br> Il est affilié au <a
